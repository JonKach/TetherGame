...
public class TetherTest {
    ...
    public void testTileCollision() {
        ...
        Collision collision1 =
                tile.collidesWith(0, 0, 10, 10, 1, 1);
        assertTrue(collision1.isCollided());
        Collision collision2 =
                tile.collidesWith(500, 100, 10, 10, 1, 1);
        assertFalse(collision2.isCollided());
    }

    @Test
    public void testPowerUp() {
        Player player = new Player(0, 0, 10, 10, 10, Color.blue, new Tile[10][20],
                null, null, "P1", null);
        Player other = new Player(0, 0, 10, 10, 10, Color.blue, new Tile[10][20],
                null, null, "P2", null);
